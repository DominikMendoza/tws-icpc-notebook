//There is a checkered sheet of paper nxm  ( n < m ), some of the cells are black.
...
//The task is to compute the number of different colored tori,
//assuming that we cannot see the glued lines, and the torus can be turned and turned.
