...
//You are given a flat subdivision with no vertices of degree one and zero, and many queries.
//Each query is a point, for which we must determine the face of the subdivision to which it belongs.
//We will answer every query in O(log n).
