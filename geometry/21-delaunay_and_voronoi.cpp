...
//The algorithm will compute the triangulation and return two quad-edges: 
//the counterclockwise convex hull edge out of the leftmost vertex and
//the clockwise convex hull edge out of the rightmost vertex.
